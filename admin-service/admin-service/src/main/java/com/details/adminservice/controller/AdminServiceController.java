...
public class AdminServiceController {
	...
	@GetMapping("/routes")   //http://localhost:8095/api/v1/routes
	...
	@PutMapping("/buses/{busid}/updateBus")
	public ResponseEntity<Bus> updateBus(@RequestBody Bus bus,@PathVariable("busid") String busid)
	{
		bus.setBusid(busid);
	...
	@PutMapping("/routes/{routeid}/updateRoute")
	...
	@DeleteMapping("/buses/{busid}/deleteBus")
	public String deleteBus(@PathVariable("busid") String busid) {
		
		return "Bus with busid->"+ busid +" "+ "deleted successfully.";
	
	}
	
	@DeleteMapping("/routes/{routeid}/deleteRoute")
